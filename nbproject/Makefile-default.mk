...
SOURCEFILES_QUOTED_IF_SPACED=lcdddemo.c lcd.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/lcdddemo.p1 ${OBJECTDIR}/lcd.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/lcdddemo.p1.d ${OBJECTDIR}/lcd.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/lcdddemo.p1 ${OBJECTDIR}/lcd.p1

# Source Files
SOURCEFILES=lcdddemo.c lcd.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lcdddemo.p1: lcdddemo.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lcdddemo.p1.d 
	@${RM} ${OBJECTDIR}/lcdddemo.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/lcdddemo.p1 lcdddemo.c 
	@-${MV} ${OBJECTDIR}/lcdddemo.d ${OBJECTDIR}/lcdddemo.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/lcdddemo.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
